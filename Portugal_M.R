...
#############################################################
# Mortality forecasting MALES Portugal mortality data with StMoMo #
# Group 5 #
###########
...
# load the data set for Portugal (males)
load(file = "PORTUGAL-males-mortality.RData")

# "PORTUGALStMoMom": StMoModata object
...
PORTUGALStMoMom$years # 1940 - 2023
PORTUGALStMoMom$type # central
PORTUGALStMoMom$series # female
...
plot(LCres,
     ...
     main = "LC Residuals Heatmap - Males")
...
plot(CBDres,
     type = "colourmap",
     reslim = c(-3.5, 3.5),
     main = "CBD Residuals Heatmap - Males")
...
# 3) compute e_{55,t:35} for LC and CBD (males, in this script)
